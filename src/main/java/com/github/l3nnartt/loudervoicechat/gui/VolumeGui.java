...
public class VolumeGui extends GuiScreen {
  ...
  public void initGui() {
    super.initGui();
    this.buttonList.add(
        new GuiButton(5, this.width / 2 - 100, this.height / 2 + 40, 200, 20, "Save"));
    this.buttonList.add(
        new GuiButton(6969, this.width / 2 - 100, this.height / 2 + 15, 200, 20, "Reset Volume"));
    GuiSlider slider =
        new GuiSlider(
            ...
            0.0F,
            500.0F,
            this.voiceChat.getVolume(this.uuid),
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    draw.drawCenteredString(
        "Change Volume of " + this.username, (this.width / 2), (this.height / 2 - 60));
